...
Public Class Bathroom
    ...
    Public Sub New(parentForm)
        ...
        Options(2) = bathroomWindow
        Options(3) = bathroomDoor
    ...
    Private Sub Livingroom_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "Other events"
    ...
    Private Sub Livingroom_Closing(sender As Object, e As CancelEventArgs) Handles MyBase.Closing
        MyParent.ResumeScanning()
    End Sub
